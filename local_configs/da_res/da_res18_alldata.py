...
model = dict(
    ...
    # parse_loss=dict(type='ParseLoss', num_losses=3),
    backbone=dict(
        # type='ResNetV1c',
        # depth=50,
        # num_stages=4,
    ...
    decode_head=dict(
        ...
        norm_cfg=norm_cfg,
        cout=64,
        upsample_scale_factor_list=[2, 4],
...
train_cfg = dict(type='IterBasedTrainLoop', max_iters=600000, val_interval=5000)

...
class Angle_EncoderDecoder(BaseSegmentor):
    ...
    def __init__(self,
        ...
        if self.parse_loss is not None:
            self.parse_loss = MODELS.build(parse_loss)
        else:
            self.parse_loss = None
    ...
    def inference(self, inputs: Tensor, batch_img_metas: List[dict]) -> Tensor:
        ...
        Returns:
            Tensor: The segmentation results, seg_logits from model of each
                input image.
        """
        # TODO:slide mode can't apply our angle-lane task now
